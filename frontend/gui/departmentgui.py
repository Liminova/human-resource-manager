...
class DepartmentGui(ctk.CTk):
    def __init__(self, master=None):
        ...
        def update_department(self):
            ...
            self.entry2 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter old ID"
            )
            entry_size(self.entry2)
            self.entry2.place(relx=0.325, rely=0.32, anchor=tkinter.CENTER)
            ...
            self.entry4 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter new ID"
            )
        ...
        self.button1 = ctk.CTkButton(
            ...
            text="Add Department",
            command=(lambda: [destroy_all_frames(self), add_department(self)]),
        )
        ...
        self.button2 = ctk.CTkButton(
            master=self.left_frame,
            text="Remove Department",
            command=(lambda: [destroy_all_frames(self), remove_department(self)]),
        )
        ...
        self.button3 = ctk.CTkButton(
            master=self.left_frame,
            text="Update Department",
            command=(lambda: [destroy_all_frames(self), update_department(self)]),
        )
