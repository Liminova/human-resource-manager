    ...
    def __init__(self, master=None):
        ...
        def add_employee(self):
            ...
            self.entry4 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter Phone Number"
            )
            ...
            self.entry5 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter Email"
            )
        ...
        def remove_employee(self):
            ...
            self.entry3 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter Department"
            )
            entry_size(self.entry3)
            self.entry3.place(relx=0.325, rely=0.445, anchor=tkinter.CENTER)
        ...
        def view_emplopyee(self):
            ...
            self.button = ctk.CTkButton(
                ...
                text="View",
                fg_color="purple",
                command=(lambda: view_employee(self)),
            )
            self.button.configure(
                width=100,
                height=40,
        ...
        self.button1 = ctk.CTkButton(
            ...
            text="Add Employee",
            command=(lambda: [destroy_all_frames(self), add_employee(self)]),
        )
        ...
        self.button2 = ctk.CTkButton(
            master=self.left_frame,
            text="Remove Employee",
            command=(lambda: [destroy_all_frames(self), remove_employee(self)]),
        )
        ...
        self.button3 = ctk.CTkButton(
            ...
            command=(lambda: [destroy_all_frames(self), update_employee(self)]),
        )
        ...
        self.button4 = ctk.CTkButton(
            master=self.left_frame,
            text="View Employee",
            command=(lambda: [destroy_all_frames(self), view_emplopyee(self)]),
        )
