...
class Homepage(ctk.CTk):
    def __init__(self, master=None):
        ...
        self.label1 = ctk.CTkLabel(
            ...
            text="Sign Out",
            text_color="cyan",
            font=("Century Gothic", 14, "underline"),
        )
        ...
        self.label2 = ctk.CTkLabel(
            master=self.frame1,
            text="You are currently sign in as: admin",
        ...
        self.button1 = ctk.CTkButton(
            ...
            command=self.click_employeegui,
        )
        ...
        self.button2 = ctk.CTkButton(
            master=self.frame1,
            text="Benefit Plan Management",
            command=self.click_benefitgui,
        )
        ...
        self.button5 = ctk.CTkButton(
            ...
            command=self.click_departmentgui,
        )
        ...
        self.button6 = ctk.CTkButton(
            ...
            command=self.click_performancegui,
        )
