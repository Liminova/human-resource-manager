...
class benefitplangui(ctk.CTk):
    def __init__(self, master = None):
        ...
        def remove_benefit_plan(self):
            ...
            self.label1 = ctk.CTkLabel(master=self.right_frame, text="Benefit name: ", font=("Century Gothic", 20, "italic"))
        ...
        def update_benefit_plan(self):
            ...
            def update_successfully(self):
                ...
                if name == "" or new_name == "" or new_description == "" or new_cost == "":
                    messagebox.showerror("Error", "Please fill in all the fields")
        ...
        self.button1 = ctk.CTkButton(master=self.left_frame, text="Add Benefit Plan", command=(lambda: [destroy_all_frames(self), add_benefit_plan(self)]))
        button_size(self.button1)
        self.button1.place(relx=0.5, rely=0.15, anchor=tkinter.CENTER)

        self.button2 = ctk.CTkButton(master=self.left_frame, text="Remove Benefit Plan", command=(lambda : [destroy_all_frames(self), remove_benefit_plan(self)]))
        button_size(self.button2)
        self.button2.place(relx=0.5, rely=0.3, anchor=tkinter.CENTER)

        self.button3 = ctk.CTkButton(master=self.left_frame, text="Update Benefit Plan", command=(lambda : [destroy_all_frames(self), update_benefit_plan(self)]))
        button_size(self.button3)
        self.button3.place(relx=0.5, rely=0.45, anchor=tkinter.CENTER)

        self.button4 = ctk.CTkButton(master=self.left_frame, text="View Benefit Plan", command=(lambda : [destroy_all_frames(self), view_benefit_plan(self)]))
        button_size(self.button4)
        self.button4.place(relx=0.5, rely=0.6, anchor=tkinter.CENTER)

        self.button5 = ctk.CTkButton(master=self.left_frame, text="Apply to the employee", command=(lambda : [destroy_all_frames(self), apply_benefit_plan(self)]))
