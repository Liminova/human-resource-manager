...
class BenefitPlanGui(ctk.CTk):
    ...
    def __admin_add_benefit_plan(self):
        ...
        def add_successfully(self):
            ...
            if name == "" or description == "" or cost == "":
                ...
                msgbox.showerror("Error", "Description must be a string")
    ...
    def __admin_remove_benefit_plan(self):
        ...
        self.entry1 = ctk.CTkEntry(master=self.right_frame, placeholder_text="Enter the benefit plan")
        self.__style_input_box(self.entry1)
        self.entry1.place(relx=0.325, rely=0.195, anchor=tkinter.CENTER)
        ...
        def remove_successfully(self):
            ...
            for e in the_company.employees:
                if os.getenv("HRMGR_DB") == "TRUE":
                    benefit_repo.delete_one({"name": benefit_name})
            msgbox.showinfo("Success", "Benefit Plan Removed")
    ...
    def __admin_update_benefit_plan(self):
        ...
        self.label0 = ctk.CTkLabel(master=self.right_frame, text="(Select a Benefit Plan: ) ", font=("Century Gothic", 14, "italic"))
        self.label0.place(relx=0.5, rely=0.095, anchor=tkinter.CENTER)

        self.entry0 = ctk.CTkComboBox(master=self.right_frame)
        self.entry0.configure(width=400, height=30, font=("Century Gothic", 14), corner_radius=10)
        ...
        def update_successfully(self):
            ...
            # update the benefit
            benefits[benefit_index].name = new_name
            benefits[benefit_index].description = new_description
            benefits[benefit_index].cost = new_cost

            if os.getenv("HRMGR_DB") == "TRUE":
                benefit_repo.update_one(
                    {"_id": benefit.id}, {"$set": {"name": new_name, "description": new_description, "cost": new_cost}}, upsert=True
                )
                msgbox.showinfo("Success", "Benefit Plan updated successfully")
    ...
    def __admin_apply_benefit_plan(self):
        ...
        self.label1 = ctk.CTkLabel(master=self.right_frame, text="Select Benefit Plan: ", font=("Century Gothic", 20, "italic"))
        ...
        def apply_successfully(self):
            ...
            # TODO: for loop here
            employee = the_company.employees[employee_id]
            ...
            msgbox.showinfo("Success", "Benefit Plan Applied")
    ...
    def __admin_view_benefit_plan(self):
        ...
        self.button = ctk.CTkButton(master=self.right_frame, text="View", fg_color="purple")
        self.button.configure(width=100, height=40, font=("Century Gothic", 15, "bold"), corner_radius=10)
        self.button.place(relx=0.5, rely=0.295, anchor=tkinter.CENTER)
        ...
        def view_benefit(self):
            ...
            benefit = benefits[benefit_index]
            # show a success message
            msgbox.showinfo("Benefit Plan", f"{benefit}")
    ...
    def __admin_list_all_plans(self):
        ...
        self.button = ctk.CTkButton(master=self.right_frame, text="List", fg_color="purple")
        self.button.configure(width=100, height=40, font=("Century Gothic", 15, "bold"), corner_radius=10)
        ...
        def list_benefits(self):
            ...
            benefit_items = [f"{benefit.name} ({benefit.cost})" for benefit in benefits]
            # show a success message
            msgbox.showinfo("Benefit Plans", f"{benefit_items}")
