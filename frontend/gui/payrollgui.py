    ...
    def __init__(self, master=None):
        ...
        def create_payroll(self):
            ...
            self.entry1 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter payroll salary"
            )
            ...
            self.entry2 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter payroll bonus"
            )
            ...
            self.entry3 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter payroll tax"
            )
            ...
            self.entry4 = ctk.CTkEntry(
                master=self.right_frame, placeholder_text="Enter payroll punishment"
            )
            ...
            def add_successfully(self):
                ...
                if salary == "" or bonus == "" or tax == "" or punishment == "":
                    ...
                    not salary.isdigit()
                    or not bonus.isdigit()
                    or not tax.isdigit()
                    or not punishment.isdigit()
                ):
                    messagebox.showerror("Error", "Please enter a valid number")
                else:
                    messagebox.showinfo(
                        "Success", "Payroll has been created successfully"
                    )
        ...
        self.button1 = ctk.CTkButton(
            ...
            text="Create Payroll",
            command=(lambda: [destroy_all_frames(self), create_payroll(self)]),
        )
        ...
        self.button2 = ctk.CTkButton(
            master=self.left_frame,
            text="Update Payroll",
            command=(lambda: [destroy_all_frames(self), update_payroll(self)]),
        )
